...
?>
    ...
    <body>
        <!-- <div  -->
        <center>
            <form style="max-width: 600px;" method="post" action="https://sandbox.payhere.lk/pay/checkout">
                <input type="hidden" name="merchant_id" value="1219994">
                <input type="hidden" name="return_url" value="http://localhost/flexsports/src/views/Customer/ViewReservations.php">
...
">
                <br><br>
                <center>
                    <div class="form-header" style="max-width:530px;">
                    ...
                    <div class="form-body">
                        <div class="horizontal-group">
                            ...
                            <div class="form-footer">
                                <input type="submit" class="btn btn-primary form_btn" value="Pay Now">
                            </div>
                        </div>
                </center>
            </form>
