...
<body>
    <section>
        ...
        <div class="content">
            <div class="textBox">
            <h2> Redefine your limits<br>with <span> FlexSports</span></h2>
            <p>FlexSports includes two each of state of the art badminton courts & squash courts. 
               It also houses a well-equipped gym where a full view of the back garden is seen with its magnificent trees. 
            ...
            <div class="imgBox">
                <img src="../../assets/Images/home.png" class="flexsports" >
            </div>
        </div>
        <ul class="sci">
