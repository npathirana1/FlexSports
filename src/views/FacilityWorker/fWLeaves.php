...
?>
    ...
    <body>
        ...
        <section class="home-section">
            ...
            <div class="box-2" style="float: right;"><button class="button leave" onClick="window.location.href='../../views/FacilityWorker/fWLeaveReqForm.php';" style="margin-right:30px;">Apply for leave</button></div>
            </div>
            </br>
            <div class="tab">
