      ...
      <nav class="sidebar">
            ...
            <ul>
                  ...
                  <li>
                        ...
                        <ul class="fac-show">
                              <li><a href="../../views/FacilityWorker/fWTodaySchedule.php">Today</a></li>
                              <li><a href="../../views/FacilityWorker/fWScheduleByFaci.php">By facilities</a></li>
                        </ul>
                  </li>
                  ...
                  <li>
                        <a class="prof-btn"><i class="fa fa-id-badge"></i>&nbsp My Profile
                              <span class="fas fa-caret-down first"></span></a>
                        <ul class="prof-show">
                              <li><a class="link" href="../../views/FacilityWorker/profile.php">Profile Details</a></li>
                              <li><a class="link" href="../../views/FacilityWorker/fWShifts.php">My Shifts</a></li>
                              <li><a class="link" href="../../views/FacilityWorker/fWLeaves.php">My Leaves</a></li>
                        </ul>
                  </li>
